...
class RefreshTokenSchema(BaseModel):
    refresh_token: str = Field(..., description='refresh token for generate new access token')


class UserRegisterSchema(BaseModel):
    username: str = Field(..., min_length=5, max_length=250, description='username of the user')
    password: str = Field(..., min_length=8, description='password of the user')
    password_confirm: str = Field(..., min_length=8, description='confirm password of the user')
